...
from protos.tensorflow.core.framework import tensor_pb2 as tensorflow_dot_core_dot_framework_dot_tensor__pb2
...
_SNAPSHOTMETADATARECORD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='graph_fingerprint', full_name='tensorflow.data.experimental.SnapshotMetadataRecord.graph_fingerprint', index=0,
...
SnapshotRecord = _reflection.GeneratedProtocolMessageType('SnapshotRecord', (_message.Message,), dict(
...
SnapshotMetadataRecord = _reflection.GeneratedProtocolMessageType('SnapshotMetadataRecord', (_message.Message,), dict(
